-- Reset and setup script for Supabase database
-- This script can be run safely even if tables already exist

-- 1. DROP existing data and recreate tables
...
-- 7. Admin policies (allows all operations for authenticated users)
...
-- 8. Insert your actual portfolio data
INSERT INTO projects (id, title, description, full_description, image, completion_date, category, location, area, features, gallery, brand_logos) OVERRIDING SYSTEM VALUE VALUES
(
  1,
  '拾壹間(已完銷)',
...
-- 9. Set the sequence to continue from the highest ID
SELECT setval('projects_id_seq', 3, true);

-- 10. Insert sample hero images
...
-- Success message
SELECT 'Database setup completed successfully! Your 3 portfolio projects have been added.' as result;