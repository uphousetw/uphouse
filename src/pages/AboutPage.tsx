    ...
    <div className="mx-auto max-w-5xl space-y-16 px-4 py-16 md:px-6 lg:px-8">
      <section className="space-y-6">
        ...
        <p className="text-base text-muted-foreground md:text-lg">
          Uphouse 建設成立於 2001 年，以「讓家回歸生活本質」為信念。20
          餘年來我們專注於住宅開發，從土地評估、規劃設計到售後服務皆由專業團隊親自把關，累計交屋超過 2,800
          戶，打造出一座座值得世代傳承的住宅地標。
        </p>
      </section>
          ...
          {[
            {
              title: '城市選地策略',
              description:
                '鎖定捷運、學區、醫療資源密集的交通門戶區域，結合生活機能與增值潛力。',
            },
            {
              title: '永續建築工法',
              description:
                '導入循環建材、智慧節能監控與低碳施工流程，追求建築與環境的長期共榮。',
            },
            {
              title: '住戶全程陪伴',
              description:
                '提供專屬顧問、雲端履約平台、交屋巡檢與保固維修，為住戶建立信任感。',
            },
          ].map((item) => (
            <div key={item.title} className="rounded-3xl border border-border bg-secondary/50 p-6">
